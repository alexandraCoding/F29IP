...
public class ContainerAzureFinanceDataAccessor : IDataAccessor
{
    ...
    public void GetItem<T>(IDataReceiver dataReceiver, string url)
    {
        ...
        {
            Method = "GET",
            Uri = "https://bankproducts.orangeground-b08e00a0.westeurope.azurecontainerapps.io/" + url
        }).Then(res =>
        {
    ...
    public void SaveItem<T>(object item, string url)
    {
        ...
        RestClient.Put<T>("https://bankproducts.orangeground-b08e00a0.westeurope.azurecontainerapps.io/" + url, itemToSave).Then(customResponse =>
        {
